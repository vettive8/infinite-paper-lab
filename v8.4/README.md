...
This experiment keeps selecting and moving from `v7` and adds alignment commands.
...
- Multiple tabs of `v8.4` update notes in real time on the same browser/computer.
...
- Select multiple notes and use `Ctrl` + `Alt` + arrow keys to align their outer edges.
