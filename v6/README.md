...
This experiment keeps the find behavior from `v5` and adds live sync across open tabs.
...
- Multiple tabs of `v6` update notes in real time on the same browser/computer.
