...
This experiment keeps selecting and moving from `v7` and adds constrained movement.
...
- Multiple tabs of `v8.3` update notes in real time on the same browser/computer.
...
- Hold `Shift` while dragging selected notes to lock movement to the dominant horizontal or vertical axis.
