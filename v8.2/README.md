...
This experiment keeps selecting and moving from `v7` and adds text-line snapping while dragging.
...
- Multiple tabs of `v8.2` update notes in real time on the same browser/computer.
...
- While dragging, text lines snap to the same height as nearby text lines in other notes.
